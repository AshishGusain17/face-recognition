# python main.py  -d caffe_model -m openface_nn4.small2.v1.t7 -r output/recognizer.pickle -e output/encoder.pickle -i testing_images/a6.jpeg
...
# resize it to have a width of 600 pixels (while maintaining the aspect ratio), and then grab the image dimensions
